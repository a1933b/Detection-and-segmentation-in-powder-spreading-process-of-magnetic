...
def run(
        ...
        source=ROOT / 'imagesss',  # file/dir/URL/glob/screen/0(webcam)
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'models/model.pt', help='model path or triton URL')
